<form role="form" >
    ...
    <div class="row form-group  " >
        <div class="" ID="paperName">
            <label for="paperName=">Paper Name: <span id="req">*</span></label>
    ...
    <div class="row form-group">
        <div class="">
            <label for="Topic">Topic <span id="req">*</span></label>
            <select class="btn-lg" id="Topic">
                <option value="Compilers">Male</option>
                <option value="Re Engineering">Female</option>
            </select>
        </div>
    </div>
    <!------------Email --------->
